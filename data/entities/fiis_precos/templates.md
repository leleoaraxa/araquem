...
### list_basic
{traded_at|date_br}: {ticker} — fechamento {close_price|currency_br} (abertura {open_price|currency_br}, máx {max_price|currency_br}, mín {min_price|currency_br}) — var {daily_variation_pct|percent_raw_br}
