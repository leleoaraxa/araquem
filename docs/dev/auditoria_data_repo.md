...
| fiis_dividends_yields | sim | sim | sim | table | sim | sim | completa |
| fiis_overview | sim | sim | sim | table | sim | sim | completa |
| fiis_registrations | sim | sim | sim | list | sim | sim | completa |
| fiis_dividends | sim | sim | sim | table | sim | sim | completa |
...
| fiis_quota_prices | sim | sim | sim | table | sim | sim | completa |
| fiis_legal_proceedings | sim | sim | sim | list | sim | sim | completa |
...
| consolidated_macroeconomic | sim | sim | sim | table | sim | sim | completa |
...
### Kinds
- `table.md.j2`: maioria
- `list.md.j2`: `fiis_registrations`, `fiis_legal_proceedings`, `fiis_news`

### Padronização (pontos bons)
- Tratamento de vazio (`empty_message`) presente na maioria.
- Multi-ticker: agrupamento por ticker em entidades como `fiis_quota_prices`, `fiis_registrations`, `fiis_real_estate` quando suportado.
